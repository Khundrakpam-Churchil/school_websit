    ...
    <section className="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link to="/registration" className="rounded-full bg-schoolBlue px-6 py-3 text-white shadow-lg shadow-schoolBlue/10 hover:bg-blue-600">
              Start Registration
            </Link>
            <Link to="/notice" className="rounded-full border border-slate-300 bg-white px-6 py-3 text-slate-700 hover:border-schoolBlue hover:text-schoolBlue">
              Latest Notices
            </Link>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-soft">
            ...
            <div className="mt-6 grid gap-4">
              <Link to="/dashboard" className="rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm font-medium text-slate-700 hover:border-schoolBlue hover:text-schoolBlue">Student Dashboard</Link>
              <Link to="/academics" className="rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm font-medium text-slate-700 hover:border-schoolBlue hover:text-schoolBlue">Admit Card & Exams</Link>
              <Link to="/notice" className="rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm font-medium text-slate-700 hover:border-schoolBlue hover:text-schoolBlue">Notice Board</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 grid gap-8 lg:grid-cols-3">
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <Link to="/notice" className="mt-6 inline-flex items-center text-schoolBlue font-medium">Open Notices</Link>
        </div>
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <Link to="/fee" className="mt-6 inline-flex items-center text-schoolBlue font-medium">Check Fee Status</Link>
        </div>
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <Link to="/gallery" className="mt-6 inline-flex items-center text-schoolBlue font-medium">Browse Gallery</Link>
        </div>
      </div>
    </section>
  );
