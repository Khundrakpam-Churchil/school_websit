...
('Campus', '/slides/infrastructure.png', 'Modern school campus with green spaces'),
('Classrooms', '/slides/academics.png', 'Bright and interactive classroom environment'),
('Sports', '/slides/sports.png', 'Students practicing athletics activities'),
('Hostel', '/slides/hostel.png', 'Comfortable hostel accommodation for students'),
('Events', '/slides/playground.png', 'Outdoor campus activities and school events'),
('Campus', '/slides/infrastructure.png', 'Collaborative study spaces and learning zones');
