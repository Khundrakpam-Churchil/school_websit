        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] items-start">
          <div>
            ...
            <div className="mt-8 space-y-4 rounded-3xl border border-slate-200 bg-slate-50 p-8">
              <p className="text-sm uppercase tracking-[0.2em] text-schoolBlue font-semibold">Important reminder</p>
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-8 shadow-sm">
            ...
            {user?.role !== 'Student' ? (
              ...
              <div className="mt-6 space-y-4">
                <p className="text-slate-700 font-medium">Registration Number</p>
